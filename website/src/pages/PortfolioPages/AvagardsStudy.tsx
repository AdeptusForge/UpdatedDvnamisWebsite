...
entering, the player is greeted by several avenues through the space that serve \
to expand on the player\’s knowledge of the space before ascending the central \
staircase. For highly-direct players, the central pathway leads directly to \
the staircase, but for others, their attention can wander to either the \
lecture hall or the sparring area. All of which expands knowledge of the space \
by expanding the context & scope.'


const header2 = "Building a Better Staircase"
const paragraph3 = 'The stairs and the rooms on it were by far the hardest \
part of this level. I decided on a uniquely-slanted spiral staircase.This \
gives players unique setpieces at each portion of the stairs, and does a far \
...
const paragraph4 = 'Unfortunately I didn\’t get the time to finish the resolution \
in a satisfactory way, but I was overall pleased with the result, and my \
playtesters said likewise. I spent a large amount of time programming/bugfixing \
in the portal system, and while that did lead to unique level geometry, it also \
took time away from refinement.'
...
export default function AvagardsStudyPage()
{
  ...
  <PageTemplate>
    ...
    <ContentBlock>
      ...
      <section className="ContentRow">
        <div className="ContentTextHolder">
          <div className="ContentText"><h1>{header2}</h1><p dangerouslySetInnerHTML={{__html: paragraph3}}/></div>
        </div>
        <div className="ContentImageHolder">
