...
working as programming, and myself working as designer inside Unity.\n\nI \
was responsible for designing the game\'s ludology, the game\'s UI, and \
handling the artistic aspects of the game.'

const paragraph1 = 'The main system I designed for the game was the cooking \
...
how cooked they were. To this end, my thinking was that simplest way to \
...
to articulate design ideas programmatically because I was significantly less \
experienced than my partner. While handling the burgers was enjoyable, it was \
also difficult to understand how one might change interacting with an object \
physically through certain control schemas. This is something I would learn many \
years later, but at the time it was lacking in my design repertoire.'
