...
export default function HellforgePage()
{
  ...
  <PageTemplate>
    <ContentBlock>
      ...
      <section className="ContentExpandableRow">
        <div className="ContentExpandableHolder">
          <Expandable title="Stairway Encounter"></Expandable>
        </div>
        <div className="ContentExpandableHolder">
          <Expandable title="Hellknight Ambush"></Expandable>
        </div>
        <div className="ContentExpandableHolder">
          <Expandable title="Hellforge Core"></Expandable>
        </div>
      </section>
      <section className="ContentRow">
        <div className="ContentTextHolder">
